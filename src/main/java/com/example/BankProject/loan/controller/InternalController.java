...
//    public ResponseDTO<EntryDTO.UpdateResponse> update(@PathVariable Long applicationId, @RequestBody EntryDTO.Request request) {
//        return ok(entryService.update(applicationId, request));
//    }
//
//    @GetMapping("/entries/{entryId}")
//    public ResponseDTO<EntryDTO.Response> get(@PathVariable Long entryId) {
