...
class ArticleCommentServiceTest {
    ...
    void givenArticleCommentInfo_whenSavingArticleComment_thenSavesArticleComment() {
        ...
        given(UserRepository.getReferenceById(dto.userDto().userId())).willReturn(createUser());
        ...
        then(UserRepository).should().getReferenceById(dto.userDto().userId());
    ...
    void givenParentCommentIdAndArticleCommentInfo_whenSaving_thenSavesChildComment() {
        ...
        given(UserRepository.getReferenceById(child.userDto().userId())).willReturn(createUser());
        ...
        then(UserRepository).should().getReferenceById(child.userDto().userId());
    ...
    void givenArticleCommentId_whenDeletingArticleComment_thenDeletesArticleComment() {
        ...
        String userId = "uno";
        willDoNothing().given(articleCommentRepository).deleteByIdAndUser_UserId(articleCommentId, userId);

        // When
        sut.deleteArticleComment(articleCommentId, userId);

        // Then
        then(articleCommentRepository).should().deleteByIdAndUser_UserId(articleCommentId, userId);
    }
